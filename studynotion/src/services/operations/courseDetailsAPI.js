...
export const fetchCourseDetails = async (courseId) => {
  ...
  try {
    ...
    console.log("coursedetailresult",result);
  } 
  catch (error) {
...
export const fetchSectionDetails = async (sectionId,token) => {
  //const toastId = toast.loading("Loading...")
  let result = null
  try {
   
    // const response = await apiConnector("GET", SECTION_DETAILS_API, sectionId, { Authorization: `Bearer ${token}`, });
    const response = await apiConnector("GET", `${SECTION_DETAILS_API}/${sectionId}`, null, { Authorization: `Bearer ${token}` });
    console.log("SECTION_DETAILS_API API RESPONSE............", response)
    ...
    console.log("SECTION_DETAILS_API API ERROR............", error)
    result = error.response.data
    // toast.error(error.response.data.message);
  }
 // toast.dismiss(toastId)
...
////////////////////////////////////getsubsection data by Id/////////////////////////
export const fetchsubSectionDetails = async (subSectionId,token) => {
  //const toastId = toast.loading("Loading...")
  let result = null
  try {
   
    // const response = await apiConnector("GET", SECTION_DETAILS_API, sectionId, { Authorization: `Bearer ${token}`, });
    const response = await apiConnector("GET", `${SUBSECTION_DETAILS_API}/${subSectionId}`, null, { Authorization: `Bearer ${token}` });
    console.log("SUBSECTION_DETAILS_API API RESPONSE............", response)
    ...
    console.log("SUBSECTION_DETAILS_API API ERROR............", error)
    result = error.response.data
    // toast.error(error.response.data.message);
  }
 // toast.dismiss(toastId)
...
export const fetchCourseCategories = async () => {
  ...
  try {
   ...
   // console.log(response);
    ...
    // result = Object.values(response.data).map(category => category.name);
...
// get full details of a course for instructure
export const getFullDetailsOfCourse = async (courseId, token) => {
  //const toastId = toast.loading("Loading...")
  //   dispatch(setLoading(true));
  let result = null
  try {
    const response = await apiConnector( "POST",`${ GET_FULL_COURSE_DETAILS_AUTHENTICATED}/${courseId}`,null, { Authorization: `Bearer ${token}`, } )
