...
import { fetchsubSectionDetails, markLectureAsComplete } from "../../../services/operations/courseDetailsAPI"
  ...
  useEffect(() => {
    ;(async () => {
      ...
      if (!courseId && !sectionId && !subSectionId) {
        ...
        // console.log("filterVideoData",filteredVideoData)
        console.log("subSectionId",subSectionId);
        const subSectionData=await fetchsubSectionDetails(subSectionId,token);
        console.log("subSectionData",subSectionData);
        const filteredVideoData=subSectionData.data[0]
...
console.log("is video ended",videoEnded);
  return (
